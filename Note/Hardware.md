...
- [ ] Study Raspberry Pi [P_4][v_3]
- [ ] Read web server setup [](#my-web-server)
  - [ ] two documents.
...
- build Raspberry_Pi project in 10 days,
- done in 7-5
...
#### Reading 1 : Setup a Raspberry Pi Web Server doc
...
#### Reading 2 : Setup a Raspberry Pi Web Server
...
We start be installing **Raspbian**, then install software updates, and then install Apache, PHP and MySQL. After verifying that the web server is functioning properly, I show how to sign up for a domain name with **Google Domains**, and how to use their **Dynamic** DNS service so your domain will work with typical residential internet service providers.
...
- [link](#websiteithdomain)

##### Scikit Raspberry PI

- Scikit-learn will run on a Raspberry Pi just as well as any other Linux machine. [Link](#tflow)
